...
// ⚠️ DEV ONLY — set to false before shipping/testing real login.
// Skips the auth gate entirely so you can test screens without a login API.
...
const AppNavigator = () => {
    ...
    const shouldShowMain = SKIP_AUTH_FOR_TESTING || isAuthenticated;
